defmodule Mix.Tasks.Demo.Load do
  @moduledoc "Mix task to load the dev database from demo.sql -- used locally."

  use Mix.Task

  @shortdoc "Task to load the dev database from demo.sql"
